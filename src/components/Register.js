  ...
  return (
    <>
      ...
      <div className='flex justify-center items-center'>
        <img className='w-1/3 mx-10' src={login} alt="" />
        <form className='flex flex-col w-4/10 justify-center m-4' onSubmit={submit}>
          <h1 className='flex justify-center text-3xl font-bold my-4'>Register with DoNation ({type.toUpperCase()})</h1>
